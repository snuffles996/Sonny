...
| `sonny_add_recipe` | `extractRecipeFromUrl()` → Redis; accepts `mealType` |
| `sonny_update_recipe` | Fetch existing by slug, merge provided fields, upsert — omitted fields unchanged |
